...
type GoogleSearchQuerier struct {
...
func NewGoogleSearchQuerier() *GoogleSearchQuerier {
...
func (r *GoogleSearchQuerier) Search(keyword string) (*Result, error) {
	result := &Result{}
	var err error
...
func (r *GoogleSearchQuerier) buildUrl(keyword string) string {
	return fmt.Sprintf(r.searchURLTemplate, keyword)
}

func (r *GoogleSearchQuerier) parseHTMLPage(elem *colly.HTMLElement) string {
	return string(elem.Response.Body)
}

func (r *GoogleSearchQuerier) parseStats(elem *colly.HTMLElement) (int, error) {
...
func (r *GoogleSearchQuerier) parseAdvertises(elem *colly.HTMLElement) (int, error) {
	return len(elem.DOM.Find(r.adsSelector).Nodes), nil
}

func (r *GoogleSearchQuerier) parseLinks(elem *colly.HTMLElement) ([]Link, error) {
	linkAttr := "href"
